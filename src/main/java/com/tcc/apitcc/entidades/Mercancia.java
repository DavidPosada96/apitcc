...
public class Mercancia {
    ...
    private String departamentoDestinataro;
    ...
    public String getDepartamentoDestinataro() {
        return departamentoDestinataro;
    }

    public void setDepartamentoDestinataro(String departamentoDestinataro) {
        this.departamentoDestinataro = departamentoDestinataro;
    }
